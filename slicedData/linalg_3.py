...
def init():
    ...
    result = np.zeros(3)
    a = 1.24
    print sum2(vec1, result)
    print sum3(vec1, vec2, result)
    print sub2(vec1, result)
    print sub3(vec1, vec2, result)    
    print mul2(a, result)
    print mul3(a, vec1, result) 
    print div2(a, result)     
    print div3(a, vec1, result)  
    result = normalize(vec2)
    print result
    print normalize1(vec1)
    print normalize2(vec1, result)
    print cross(vec1, vec2)
    print cross3(vec1, vec2, result) 
    print dot(vec1, vec2)
    print norm(vec1)
