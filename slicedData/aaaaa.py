...
def runrun(imagenum):
    ...
    box_pc = sio.loadmat('bfx_alignData_with_nan_19_classes/image%04d/annotation_pc.mat' % (imagenum)); # pc generate by bin.....SUN3Dtoolbox/generate_pc_3dBox.m
    pc = box_pc['points3d']; 
    ...
    occu_map = None#z_buffer(voxel_world, idxx, idxy, idxz)
